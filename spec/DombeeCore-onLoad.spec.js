...
describe("Dombee.onLoad", function() {
    ...
    it("function should have Dombee Object as first parameter", function() {
        ...
        Dombee.onLoad(spyFunction);
        Dombee({});
        expect(spyFunction).toHaveBeenCalledWith({ state: {}, cache: { _localDumbeeCache: true, bindings: {}, stateDependencies: {}, dependencies: {} }, $root: Dombee.documentMock.createElement('div') });
    });
});